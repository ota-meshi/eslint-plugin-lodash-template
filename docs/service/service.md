...
This plugin's parser provides [MicroTemplateService](./../../lib/service/MicroTemplateService.js) from `parserServices`.
...
- [template-tag-spacing.js](./../../lib/rules/template-tag-spacing.js) is an example.

## Traverse HTML

- To traverse HTML we use the `traverseDocumentNodes` method.
- [ast-for-html.md](./ast-for-html.md) is HTML AST specification.
- [no-html-comments.js](./../../lib/rules/no-html-comments.js) is an example.
