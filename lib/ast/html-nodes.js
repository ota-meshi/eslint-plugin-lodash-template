 ...
 */
class HTMLAssociation extends HTMLToken {
    /**
     * constructor.
     * @param  {string} html The html text.
     * @param  {number} startIndex The start index of range.
...
class HTMLAttribute extends HTMLNode {
     ...
     * @returns {string} The raw key name
     */
    get rawKey() {
        return this.keyToken.value
    }

    /**
     * Get the key token
     * @returns {string} The key token
     */
    get keyToken() {
        if (!this._keyToken) {
