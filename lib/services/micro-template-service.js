...
class MicroTemplateService {
    ...
    isDisableMessageForHtml(message) {
        if (!this._htmlCommentDirectiveContext) {
            this._htmlCommentDirectiveContext = commentDirective.createHtmlCommentDirectiveContext(
                !this._doc,
                this.template,
                this
            )
    ...
    isDisableMessageForEjs(message) {
        if (!this._ejsCommentDirectiveContext) {
            this._ejsCommentDirectiveContext = commentDirective.createEjsCommentDirectiveContext(
                this
            )
        }
