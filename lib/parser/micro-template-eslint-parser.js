...
/**
 * When possible, RegExp is generated with `unicode` enabled.
 * If it can not be generated, RegExp is generated with `unicode` disabled.
...
function newRegExp(pattern, flags = "") {
    try {
        return new RegExp(
            pattern,
            flags.indexOf("u") >= 0 ? flags : `${flags}u`
        )
    } catch (_) {
