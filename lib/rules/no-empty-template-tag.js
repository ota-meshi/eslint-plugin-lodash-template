...
module.exports = {
    meta: {
        docs: {
            description:
                "disallow empty micro-template interpolation/evaluate(s). (ex. :-1: `<% %>`)",
            category: "best-practices",
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.0.1/docs/rules/no-empty-template-tag.md",
        },
        fixable: null,
        schema: [],
    },
