...
module.exports = {
    meta: {
        docs: {
            description:
                "disallow specified warning terms in HTML comments. (ex. :-1: `<!-- TODO:task -->`)",
            category: "best-practices",
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.0.1/docs/rules/no-warning-html-comments.md",
        },
        schema: [
            {
                type: "object",
