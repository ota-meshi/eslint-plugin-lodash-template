...
module.exports = {
    meta: {
        docs: {
            description:
                "enforce unified spacing in micro-template interpolation/evaluate(s). (ex. :ok: `<%= prop %>`, :ng: `<%=prop%>`)",
            category: "recommended",
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.0.2/docs/rules/template-tag-spacing.md",
        },
        fixable: "whitespace",
        schema: [
            {
