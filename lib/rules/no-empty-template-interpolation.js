...
module.exports = {
    meta: {
        docs: {
            description:
                "disallow empty micro-template interpolations. (ex. `<% %>`)",
            category: "best-practices",
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.0.0/docs/rules/no-empty-template-interpolation.md",
        },
        fixable: null,
        schema: [],
    },
