...
module.exports = {
    meta: {
        docs: {
            description:
                "enforce unified spacing in micro-template interpolations. (ex. `<%=prop%>`)",
            category: "recommended",
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.0.0/docs/rules/template-interpolation-spacing.md",
        },
        fixable: "whitespace",
        schema: [
            {
