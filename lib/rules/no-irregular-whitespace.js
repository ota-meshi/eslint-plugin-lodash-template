...
module.exports = {
    meta: {
        docs: {
            ...
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.8.0/docs/rules/no-irregular-whitespace.md",
        },
        fixable: "whitespace",
        schema: [
            {
        ...
        function checkForIrregularWhitespace(node, ignoreTokens) {
            ...
            while ((match = IRREGULAR_WHITESPACE.exec(text)) !== null) {
                ...
                context.report({
                    ...
                    message: `Irregular whitespace (\\u{{code}}) not allowed.`,
                    data: { code },
