...
module.exports = {
    meta: {
        docs: {
            ...
            url: "https://ota-meshi.github.io/eslint-plugin-lodash-template/rules/html-indent.html",
        },
        fixable: "whitespace",
        messages: {
                ...
                HTMLText(node) {
                    ...
                    const textNode =
                        microTemplateService.findToken(
                            microTemplateService.getPathCoveredHtmlDocument(
                                node,
                                sourceCode
                            ),
                            (n) =>
        ...
        function processEvaluates() {
            ...
            function setOffsetToRangeLinesForSwitch(
                ...
                for (
                    ...
                    const switchCaseInfo =
                        findSwitchCaseBodyInfoAtLineStart(lineNo);
                    if (!switchCaseInfo) {
                        continue;
                    }
