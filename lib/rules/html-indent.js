...
module.exports = {
    meta: {
        docs: {
            ...
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.3.0/docs/rules/html-indent.md",
        },
        fixable: "whitespace",
        schema: [
            {
        ...
        function processAdjustEndTags() {
            ...
            for (const invalidTarget of invalidCandidateEndTags) {
                ...
                microTemplateService.traverseTokens(doc, {
                    HTMLEndTag(node) {
                        if (!equalsLocation(invalidTarget.endTag, node)) {
                            return
                        }
