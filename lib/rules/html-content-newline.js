...
/**
 * Check whether the given node is a nultiline
 ...
 * @returns {boolean} `true` if the node is a nultiline.
 */
...
module.exports = {
    meta: {
        docs: {
            ...
            url:
                "https://github.com/ota-meshi/eslint-plugin-lodash-template/blob/v0.6.0/docs/rules/html-content-newline.md",
        },
        fixable: "whitespace",
        schema: [
            {
